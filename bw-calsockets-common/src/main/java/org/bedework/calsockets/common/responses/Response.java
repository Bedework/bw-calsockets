...
import static org.bedework.calsockets.common.responses.Response.Status.validationError;
...
public class Response extends MessageBase {
  ...
  public Response(final String action) {
    super(action);
  }
  ...
  public static Response ok(final String response) {
    return ok(new Response(response), null);
  }
